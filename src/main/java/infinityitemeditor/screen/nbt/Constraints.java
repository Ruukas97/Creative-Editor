...
import ruukas.ruukasgui.util.MathUtil;
...
public class Constraints {
    ...
    public int constrainWidth(int width){
        return MathUtil.clamp(width, minWidth, maxWidth);
    }

    public int constrainHeight(int height){
        return MathUtil.clamp(height, minHeight, maxHeight);
    }
    ...
    public Constraints enforce(Constraints constraints){
        int minWidth = MathUtil.clamp(this.minWidth, constraints.minWidth, constraints.maxWidth);
        int maxWidth = MathUtil.clamp(this.maxWidth, constraints.minWidth, constraints.maxWidth);
        int minHeight = MathUtil.clamp(this.minHeight, constraints.minHeight, constraints.maxHeight);
        int maxHeight = MathUtil.clamp(this.maxHeight, constraints.minHeight, constraints.maxHeight);
    ...
    public Constraints tighten(int width, int height){
        return Constraints.tight(MathUtil.clamp(width, minWidth, maxHeight), MathUtil.clamp(height, minHeight, maxHeight));
    }
