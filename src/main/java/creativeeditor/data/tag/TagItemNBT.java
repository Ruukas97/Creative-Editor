...
public class TagItemNBT extends DataMap {
	...
	// Attributes: https://minecraft.gamepedia.com/Player.dat_format#Attribute_Modifiers
	...
	// Written Books: https://minecraft.gamepedia.com/Player.dat_format#Written_Books
	...
	@Nonnull
	public DataRange getGenerationTag() {
		return (DataRange) getDataDefaulted("generation", new DataRange(0, 0, 3));
	}
	...
	// Armor Stands and Spawn Eggs: https://minecraft.gamepedia.com/Player.dat_format#Armor_Stands_and_Spawn_Eggs
	...
	// Buckets of Fish: https://minecraft.gamepedia.com/Player.dat_format#Buckets_of_Fish
	...
	// Suspicious Stew: https://minecraft.gamepedia.com/Player.dat_format#Suspicious_Stew
