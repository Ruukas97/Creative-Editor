...
public class PlayerLayer extends LayerRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
    ...
    public static void init() {
        ...
        PlayerRenderer renderer = mc.getRenderManager().getRenderer( AbstractClientPlayerEntity.class );
        mc.getRenderManager().getSkinMap().get( "default" ).addLayer( new PlayerLayer( renderer ) );
        mc.getRenderManager().getSkinMap().get( "slim" ).addLayer( new PlayerLayer( renderer ) );
    }
