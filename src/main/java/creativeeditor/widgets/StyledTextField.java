...
public class StyledTextField extends Widget implements IRenderable, IGuiEventListener {
	...
	public StyledTextField(FontRenderer fontIn, int p_i51137_2_, int p_i51137_3_, int p_i51137_4_, int p_i51137_5_,
			String msg) {
		this(fontIn, p_i51137_2_, p_i51137_3_, p_i51137_4_, p_i51137_5_, (StyledTextField) null, msg);
	}

	public StyledTextField(FontRenderer fontIn, int xIn, int yIn, int widthIn, int heightIn,
			@Nullable StyledTextField p_i51138_6_, String msg) {
	...
	public boolean charTyped(char char1, int char2) {
		if (!this.getActive()) {
			return false;
		} else if (SharedConstants.isAllowedCharacter(char1)) {
			if (this.isEnabled) {
