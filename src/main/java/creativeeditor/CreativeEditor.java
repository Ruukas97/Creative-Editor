...
public class CreativeEditor {
	...
	public CreativeEditor() {
		...
		OFF_HAND_SWING = new KeyBinding("key.offhandswing", InputMappings.INPUT_INVALID.getKeyCode(),
				"Creative Editor");
	...
	public void onKeyInput(final KeyInputEvent event) {
		...
		if (event.getKey() == OPEN_EDITOR_KEY.getKey().getKeyCode()) {
			...
			if (entity != null) {
				...
				mc.displayGuiScreen(
						new ItemInspectorScreen(mc.currentScreen, new DataItem(mc.player.getHeldItemMainhand())));
			}
