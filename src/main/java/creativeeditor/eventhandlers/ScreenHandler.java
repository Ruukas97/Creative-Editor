...
public class ScreenHandler {
	...
	public void onInitGui(GuiScreenEvent.InitGuiEvent e) {
		/*if (e.getGui() instanceof CreativeScreen) {
			CreativeScreen creative = (CreativeScreen)e.getGui();
			e.addWidget(new StyledButton(creative.getGuiLeft(), creative.getGuiTop(), 30, 20, I18n.format("creativeeditor.switchgamemode"), b -> PlayerUtils.switchGamemode()));
		} else */
